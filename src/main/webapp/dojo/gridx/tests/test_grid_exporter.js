require([
	...
	modules = [
		mods.CellWidget,				//add Widget to cell
		mods.ExtendedSelectRow,			//multiple rows select
		mods.SingleSort,				//sort the data
		mods.Filter,					//filter u know
		mods.FilterBar,
		mods.Pagination,				//pagination u know
		mods.PaginationBar,
		mods.VirtualVScroller			//Scroller v
	];
